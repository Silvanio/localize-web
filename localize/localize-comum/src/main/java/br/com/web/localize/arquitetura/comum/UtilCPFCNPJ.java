...
public class UtilCPFCNPJ {
	...
	/**
	 * 094.* @param number A imcomplete number (CPF = 9, CNPJ = 12) 095.* @return The complete number 096.
	 */
	 ...
	 */
	public UtilCPFCNPJ( String cpfCnpj ) {
	 ...
	 * <P>
	 * 146.* <code>return this.toString().equals(obj.toString());</code> 147.* @see java.lang.Object#equals(java.lang.Object) 148.
	 */
	...
	/**
	 * Determines if the object is a CNPJ. 180.* @return true if the object is a CNPJ and 181.* False if the object is a CPF or invalid 182.
	 */
	...
	/**
	 * Determines if the object is a CPF 188.* @return true if the object is a CPF and 189.* False if the object is a CNPJ or invalid 190.
	 */
	 ...
	 * 196.* The object must be a CPF or a CNPJ. 197.* @return True - is Valid, False - is Invalid 198.
	 */
	...
	/**
	 * 204.* @see org.brazilutils.validation.Validable#isValid() 205.* @return true id is valid and false if is not 206.
	 */
	 ...
	 * 212.* You can use "123.456.789-01" or "12345678901" 213.* @param cpfCnpj The Cpf or Cnpj number 214.
	 */
	 ...
	 * 235.* @see java.lang.Object#toString() 236.* @see org.brazilutils.utilities.NumberComposed#getCpfCnpj() 237.
	 */
